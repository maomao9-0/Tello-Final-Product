...
while True:
    ...
    for output in layer_outputs:
        ...
        # bounding boxes
        idxs = cv2.dnn.NMSBoxes(boxes, confidences, YOLO_CONFIDENCE, YOLO_THRESHOLD).flatten()
    ...
    cv2.imshow("TelloLiveview", image)  # do not remove this line. Without this line that is no video.
